...
class FetchAPI_Service {
  ...
  public static async retrieveData<RawValidResponseData extends ArbitraryObject>(
  ...
  public static async submitData<RawValidResponseData extends ArbitraryObject>(
    namedParameters:
      Readonly<
        (
          { alternatingURI_PathPart: string; } |
